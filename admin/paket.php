                        ...
                        <div class="modal-dialog">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <p>Apakah anda yakin akan menghapus <b><?php echo $d_tb_paket['nama_paket']; ?></b>...</p>
                            </div>
                              ...
                              <div class="modal-body">
                                ...
                                <div class="form-group">
                                  ...
                                  <select class="form-control" name="jenis">
                                    ...
                                    <option value="kiloan" <?php if ($d_tb_paket['jenis'] == 'kiloan'){echo 'selected';} ?>>Kiloan</option>
                                    <option value="selimut" <?php if ($d_tb_paket['jenis'] == 'selimut'){echo 'selected';} ?>>Selimut</option>
                                    <option value="bed cover" <?php if ($d_tb_paket['jenis'] == 'bed cover'){echo 'selected';} ?>>Bed Cover</option>
                                    <option value="kaos" <?php if ($d_tb_paket['jenis'] == 'kaos') {echo 'selected';} ?>>Kaos</option>
                                    <option value="dll" <?php if ($d_tb_paket['jenis'] == 'dll') {echo 'selected';} ?>>DLL</option>
                                  </select>
                                </div>
                                <div class="form-group">
