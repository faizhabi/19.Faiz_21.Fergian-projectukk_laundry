                            ...
                            <div class="modal-content">
                                ...
                                <form method="post" action="update_outlet.php">
                                  <div class="modal-body">                                    
                                    ...
                                    <div class="form-group">
                                        <label>Telepon</label>
                                        <input type="text" name="tlp" class="form-control" value="<?php echo $d_tb_outlet['tlp']; ?>" placeholder="Masukan Nama">
                                    </div>
                                  </div>
                                    <div class="modal-footer justify-content-between">
                                      <button type="button" class="btn btn-default" data-dismiss="modal">Keluar</button>
                            ...
                            <div class="modal-content">
                                ...
                                <form method="post" action="simpan_outlet.php">
                                  <div class="modal-body">                                    
                                    ...
                                    <div class="form-group">
                                        <label>Telepon</label>
                                        <input type="text" name="tlp" class="form-control" placeholder="Masukan Nama">
                                    </div>
                                  </div>
                                    <div class="modal-footer justify-content-between">
                                      <button type="button" class="btn btn-default" data-dismiss="modal">Keluar</button>
