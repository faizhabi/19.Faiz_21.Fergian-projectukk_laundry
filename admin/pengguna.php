                              ...
                              <div class="modal-body">
                                ...
                                <div class="form-group">
                                  ...
                                  <select class="form-control" name="role">
                                    ...
                                    <option value="admin"<?php if ('admin' == $d_tb_user['role']) {
                                                                                  echo 'selected';
                                                                                } ?>>Admin</option>
                                    <option value="kasir"<?php if ('kasir' == $d_tb_user['role']) {
                                                                                  echo 'selected';
                                                                                } ?>>Kasir</option>
                                    <option value="owner"<?php if ('owner' == $d_tb_user['role']) {
                                                                                  echo 'selected';
                                                                                } ?>>Owner</option>
                                  </select>
                                </div>
                            ...
                            <div class="form-group">
                              ...
                              <div class="form-group">
                                ...
                                <select class="form-control" name="role">
                                  ...
                                  <option value="kasirn">Kasir</option>
