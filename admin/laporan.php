                                ...
                                <tbody>
                                    ...
                                    while ($d_tb_transaksi = mysqli_fetch_array($tb_transaksi)) {
                                        ...
                                        while ($d_tb_paket_d = mysqli_fetch_array($tb_paket)) {
                                            $tb_outlet = mysqli_query($koneksi, "SELECT * FROM tb_outlet where id='$d_tb_paket_d[id_outlet]'");
                                            while ($d_tb_outlet_d = mysqli_fetch_array($tb_outlet)) {
                                                ...
                                                while ($d_tb_member_d = mysqli_fetch_array($tb_member)) {
                                                    $tb_user = mysqli_query($koneksi, "SELECT * FROM tb_user where id='$d_tb_transaksi[id_member]'");
                                    ...
                                    ?>
                                                        <tr>
                                                            ...
                                                            <td><?= $d_tb_transaksi['qty'] ?> <?= $d_tb_paket_d['jenis'] ?><?php ?></td>
                                                            <td>
                                                                <?php
                                                            ...
                                                            <td>
                                                                <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modal-status<?php echo $d_tb_transaksi['id']; ?>"><i class="fas fa-edit"></i>Ubah</button>
                                                            </td>
                                                            <td>
                                                                <?php
                                                                if ($d_tb_transaksi['dibayar'] == 'dibayar') { ?>
                                                        ...
                                                        <div class="modal fade" id="modal-batalkan<?php echo $d_tb_transaksi['id']; ?>">
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <p>Apakah anda belum menerima dana transaksi ini sebesar <b><?php
                                                                                                                                    $a = $d_tb_paket_d['harga'];
                                                                                                                                    $b = $d_tb_transaksi['qty'];
                                                                                                                                    $c = $d_tb_transaksi['biaya_tambahan'];
                                                                                                                                    $total = ($a * $b) + $c;
                                                                    ...
                                                                    <form method="post" action="update_bayar_transaksi.php">
                                                                        <div class="modal-body">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="text" name="id_paket" value="<?php echo $d_tb_paket['id']; ?>" hidden>
                                                                            </div>
                                                                        </div>
                                                                        <div class="modal-footer justify-content-between">
                                                                            <button type="button" class="btn btn-default" data-dismiss="modal">Keluar</button>
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <form method="post" action="update_transaksi.php">
                                                                            ...
                                                                            <div class="form-group">
                                                                                <label>Berat</label>
                                                                                <input type="text" name="qty" value="<?php echo $d_tb_transaksi['qty']; ?>" class="form-control" placeholder="Nama berat">
                                                                            </div>

                                                                            <div class="form-group">
                                                                                <label>Biaya Tambahan</label>
                                                                                <input type="text" name="biaya_tambahan" value="<?php echo $d_tb_transaksi['biaya_tambahan']; ?>" class="form-control" placeholder="Nama biaya tambahan">
                                                                            </div>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form method="post" action="simpan_transaksi.php">
                                                        <div class="form-group">
                                                            <label>Invoice</label>
                                                            <input type="text" name="kode_invoice" class="form-control" value="INV<?php echo date('dmY His'); ?>" readonly>
                                                        </div>
                                                        <div class="form-group">
                                                            <label>Pilih Member</label>
                                                            <select class="form-control" name="id_member">
                                                        ...
                                                        <div class="form-group">
                                                            <label>Berat</label>
                                                            <input type="text" name="qty" class="form-control" placeholder="Nama berat">
                                                        </div>

                                                        <div class="form-group">
                                                            <label>Biaya Tambahan</label>
                                                            <input type="text" name="biaya_tambahan" class="form-control" placeholder="Nama biaya tambahan">
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="date" name="batas_waktu" class="form-control" placeholder="Nama biaya tambahan">
                                                        </div>
