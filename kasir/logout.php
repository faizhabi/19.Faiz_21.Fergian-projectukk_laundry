                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <a href="print_laporan.php" class="btn btn-primary" blank="blank_"><i class="fas fa-print"></i></a>
                      </td>
                    </tr>
                    ...
                    <div class="modal fade" id="modal-hapus">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <a href="hapus_laporan_transaksi.php" class="btn btn-primary">Hapus</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modal fade" id="modal-bayar">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer justify-content-between">
                                <button type="button" class="btn btn-default" data-dismiss="modal">Keluar</button>
                                <a href="hapus_laporan_transaksi.php" class="btn btn-primary">Bayar</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modal fade" id="modal-batalkan">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer justify-content-between">
                                <button type="button" class="btn btn-default" data-dismiss="modal">Keluar</button>
                                <a href="hapus_laporan_transaksi.php" class="btn btn-primary">Simpan</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modal fade" id="modal-ubah-status">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form method="post" action="edit_laporan_transaksi.php">
                                <div class="modal-body">                                    
                    ...
                    <div class="modal fade" id="modal-edit">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h4 class="modal-title">Edit Data Laporan Transaksi</h4>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                    ...
                    <div class="modal fade" id="modal-tambah">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form method="post" action="tambah_laporan_transaksi.php">
                                <div class="modal-body">                                    
                                <div class="form-group">
                                        <label>Pilih Member</label>
                                        <select class="form-control">
